...
from .routers import auth, users, reports, trend_flows, admin, redemption_codes, mcp, chat, oss, galleries, report_mcp_internal, trend_flow_mcp_internal, agent_mcp_internal, favorites
...
app.include_router(trend_flows.router, prefix="/api")
...
app.include_router(trend_flow_mcp_internal.router, prefix="/api")
